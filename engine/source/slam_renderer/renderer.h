...
public:
    ...
    std::shared_ptr<texture> get_register_texture(std::string path, bool isSRGB = false, texture_type type = texture_type::texture_2d, int width = 0, int height = 0, int samples = 1);
